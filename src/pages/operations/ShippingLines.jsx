...
const ShippingLines = () => {
  ...
  const totalRoutes =
    ships?.reduce((acc, ship) => acc + (ship.routes?.length || 0), 0) || 0;
  const avgRoutes = totalShips ? (totalRoutes / totalShips).toFixed(1) : 0;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="stat-card bg-gradient-to-br from-emerald-500 to-emerald-600 text-white">
              <ArrowLeftIcon className="stat-icon-bg h-24 w-24 rotate-180 opacity-10" />
              <div className="stat-content">
                <div>
            ...
            <div className="stat-card bg-gradient-to-br from-indigo-500 to-indigo-600 text-white">
              ...
              <div className="stat-content">
                <div>
                  <p className="stat-title">Avg Routes per Ship</p>
                  <p className="stat-value">{avgRoutes}</p>
                </div>
                <div className="p-2 bg-white/20 rounded-lg backdrop-blur-sm">
                  <CubeIcon className="h-6 w-6" />
                </div>
