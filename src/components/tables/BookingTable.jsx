  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="table-cell-stack">
            <div className="table-text-bold">{toCaps(row.original.shipper)}</div>
            {row.original.phone && (
              <div className="table-subtext">{toCaps(row.original.phone)}</div>
            )}
          </div>
        ),
      },
      {
        ...
        cell: ({ row }) => (
          <div className="table-cell-stack">
            <div className="table-text-bold">{toCaps(row.original.consignee)}</div>
